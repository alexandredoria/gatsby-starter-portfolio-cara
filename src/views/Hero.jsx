...
const Hero = ({ children, offset }) => (
  <>
    <Divider speed={0.2} offset={offset}>
      <UpDown>
        <SVG icon="triangle" width={48} stroke={colors.orange} left="9em" top="20%" />
        <SVG icon="hexa" width={48} stroke={colors.red} left="60%" top="70%" />
        <SVG icon="box" hiddenMobile width={6} fill={colors['grey-darker']} left="60%" top="15%" />
      </UpDown>
      <UpDownWide>
        ...
        <SVG icon="circle" width={12} fill={colors['grey-darkest']} left="13.5em" top="9.3%" />
      </UpDownWide>
      ...
      <SVG icon="box" width={12} fill={colors['grey-darkest']} left="74%" top="51%" />
