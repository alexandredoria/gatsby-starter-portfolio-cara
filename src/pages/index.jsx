...
const Index = () => (
  <>
    ...
    <StickRightSide>
      <ChangeLanguage>
        <ShadowSpan>
          Linguagem do site: <b>Português</b>&nbsp;
        </ShadowSpan>
      ...
      <a href="./CV_AlexandreDoria_pt.pdf" download>
      <Button>
    ...
    <Parallax pages={5}>
      <Hero offset={0}>
        <BigTitle>
          Olá, <br /> Sou Alex Dória.
        </BigTitle>
        <Subtitle>Eu crio boas experiências na web para a próxima geração de empresas voltadas para o consumidor.</Subtitle>
      </Hero>
      <Projects offset={1}>
        <Title>Projetos</Title>
        <ProjectsWrapper>
          <ProjectCard
            title="Escritório Antônio Novais Filho"
            link="http://antonionovaisfilho.com/"
            bg="linear-gradient(to right, #D4145A 0%, #FBB03B 100%)"
          >
            Freelance de Desing, SEO e desenvolvimento...
          </ProjectCard>
         {/*  <ProjectCard
            title="Harry Potter"
      ...
      <About offset={3}>
        ...
        <AboutHero>
          ...
          <AboutSub>
            Nascido para criar e compartilhar.
          </AboutSub>
        </AboutHero>
        <AboutDesc>
          Programador desde os 14 anos, com experiência nas linguagens PHP, Javascript e Java, também possui conhecimento em áreas como modelagem de sistemas, segurança da informação, redes de computadores e gerenciamento de projetos. Em 2018, se tornou Scrum Master e desde então ele percebe as habilidades de conectar e impulsionar as pessoas.
          <p> Fluente em português, proficiente em <ShadowSpan><b>inglês</b></ShadowSpan>, <ShadowSpan><b>francês</b></ShadowSpan> básico e iniciante em <ShadowSpan><b>espanhol</b></ShadowSpan>.</p>
          Então, por que não entrar em contato comigo? 
        </AboutDesc>
      </About>
      <Contact offset={4}>
        <Inner>
          ...
          <ContactText>
            Mande um <a href="mailto:alexandredoria.01@hotmail.com">Oi</a> ou me encontre em outras plataformas:{' '}
        ...
        <Footer>
          &copy; 2019 por Alexandre Dória - Portfólio.
        </Footer>
      </Contact>
    </Parallax>
  </>
